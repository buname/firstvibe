...
export default function VannaChartWidget() {
    ...
    <div className="flex h-full min-h-[180px] flex-col">
      ...
      <div className="min-h-0 flex-1">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart layout="vertical" data={vannaRows} margin={{ top: 4, right: 12, left: 4, bottom: 4 }}>
            ...
            <Bar dataKey="v" barSize={9} radius={[0, 3, 3, 0]} isAnimationActive={false}>
              {vannaRows.map((e, i) => (
                <Cell key={i} fill={e.v >= 0 ? "#f97316" : "#818cf8"} />
              ))}
            </Bar>
          </BarChart>
        </ResponsiveContainer>
