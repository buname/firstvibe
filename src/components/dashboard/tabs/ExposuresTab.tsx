  ...
  return (
    <div className="h-full flex overflow-hidden p-2 gap-2">
      ...
      <div className="flex-1 flex flex-col gap-2 min-w-0 min-h-0">
        {/* Tab subtitle */}
        <div className="text-[9px] font-mono text-[#444] flex-shrink-0 tracking-wider">
          {chain[0]?.expiry?.slice(0, 10) ?? "—"} · gamma, vanna, charm by
          strike
        </div>

        {/* GEX horizontal bar chart */}
        <div className="flex-[3] min-h-0 bg-[#0d0d0d] border border-[#1e1e1e] rounded p-2 flex flex-col">
          <div className="text-[9px] font-mono font-bold tracking-widest text-[#555] mb-1 flex-shrink-0 uppercase">
        ...
        <div className="flex-[2] flex gap-2 min-h-0">
          {/* Vanna */}
          <div className="flex-1 min-h-0 min-w-0 bg-[#0d0d0d] border border-[#1e1e1e] rounded p-2 flex flex-col">
            <div className="flex items-center justify-between mb-1 flex-shrink-0">
              <div>
                <div className="text-[9px] font-mono font-bold tracking-widest text-[#555] uppercase">
                  Vanna by Strike
                </div>
                <div className="text-[8px] font-mono text-[#383838]">
                  IV Sensitivity
                </div>
              </div>
